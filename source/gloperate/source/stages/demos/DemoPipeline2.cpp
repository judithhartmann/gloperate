...
#include <gloperate/stages/demos/DemoPipeline2.h>
...
CPPEXPOSE_COMPONENT(DemoPipeline2, gloperate::Stage)


DemoPipeline2::DemoPipeline2(Environment * environment, const std::string & name)
